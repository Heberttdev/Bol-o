        ...
        <div className="dash-header">
          ...
          <div className="quick-actions">
            <button onClick={importarJogos} style={{ display: "flex", alignItems: "center", gap: "6px" }}>
              <Download size={16} /> Importar Brasileirão
            </button>
            ...
            return (
              <div key={jogo.id} className="game-card-bet">
                ...
                <div className="bet-row">
                  ...
                  <button className="btn-bet" onClick={() => {
                    const casa = document.getElementById(`res-casa-${jogo.id}`).value;
                    const fora = document.getElementById(`res-fora-${jogo.id}`).value;
